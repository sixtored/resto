...
<html>
<head>
<title>SixtoRed - Ejemplo carta online</title>
<meta charset="UTF-8">
...
<div class="w3-top w3-hide-small">
  <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    ...
    <a href="#myMap" class="w3-bar-item w3-button">CONTACTO</a>
  </div>
</div>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-bottomleft w3-padding">
    <span class="w3-tag w3-xlarge">Abierto de 20:00 a 0:00 hs.</span>
  </div>
  <div class="w3-display-middle w3-center">
    <span class="w3-text-white w3-hide-small" style="font-size:100px">SU<br>ESPECIAL PIZZAS</span>
    <span class="w3-text-white w3-hide-large w3-hide-medium" style="font-size:60px"><b>SU<br>ESPECIAL PIZZAS</b></span>
    <p><a href="#menu" class="w3-button w3-xxlarge w3-black">Vea nuestro menu</a></p>
  </div>
</header>
  ...
  <div class="w3-content">
    ...
    <div class="w3-row w3-center w3-border w3-border-dark-grey">
      <a href="javascript:void(0)" onclick="openMenu(event, 'Pizza');" id="myLink">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Entradas</div>
      </a>
      <a href="javascript:void(0)" onclick="openMenu(event, 'Pasta');">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Pizzas</div>
      </a>
      <a href="javascript:void(0)" onclick="openMenu(event, 'Starter');">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Sandwich</div>
      </a>
    </div>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p>El Restaurante Pizza fue fundado en blabla por el Sr. Italiano in lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge">
  <div class="w3-content">
    <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">Contact0</h1>
    <p>Encientrenos en la direccion o llamenos al 05050515-122330</p>
    <p><span class="w3-tag">¡Para tu información!</span>Ofrecemos servicio completo de catering para cualquier evento, grande o pequeño. Entendemos sus necesidades y atenderemos la comida para satisfacer los criterios más importantes de todos, tanto en apariencia como en sabor.</p>
    <p class="w3-xxlarge"><strong>Reserve</strong>una mesa, pregunte por el especial de hoy o simplemente envíenos un mensaje:</p>
    <form action="/action_page.php" target="_blank">
      <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Nombre" required name="Name"></p>
      <p><input class="w3-input w3-padding-16 w3-border" type="number" placeholder="Cuentas personas" required name="People"></p>
      ...
      <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Mensaje \ Requerimiento especial" required name="Message"></p>
      <p><button class="w3-button w3-light-grey w3-block" type="submit">ENVIAR MENSAJE</button></p>
    </form>
  </div>
</div>
...
<footer class="w3-center w3-black w3-padding-48 w3-xxlarge">
  <p>Powered by <a href="http://www.sixtored.com.ar" title="SixtoRed" target="_blank" class="w3-hover-text-green">SixtoRed</a></p>
</footer>
